...
<svelte:head>
	<title>Projects — Felipe Bueno</title>
</svelte:head>

<!-- Esta rota não tem ícone de linha: as linhas vêm de `project`, sem campo `icon`. -->
<IconSprite ids={['arrow', 'arrow-left']} />

<p>
	<a class="back" href="/"
		><Icon name="arrow-left" kind="arrow" label="Back to" />
		Felipe Bueno</a
	>
</p>
